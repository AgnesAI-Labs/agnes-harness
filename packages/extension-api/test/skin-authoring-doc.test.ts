...
const doc = readFileSync(new URL('docs/develop/skins.md', repoRoot), 'utf8')
 ...
 */
describe('skin authoring guide matches the contract', () => {
  ...
  it('points at a checked-in example that really satisfies the contract', () => {
    ...
    const target = new URL(`${relative as string}/`, new URL('docs/develop/skins.md', repoRoot))
