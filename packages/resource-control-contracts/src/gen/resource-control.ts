...
export const ResourceControlSchema = Type.Module({
  ...
  "SkillDescriptor": Type.Object({ "kind": Type.Literal('skill'), "resourceId": Type.Ref('ResourceId'), "name": Type.String({ minLength: 1, maxLength: 128 }), "description": Type.Optional(Type.String({ maxLength: 512 })), "revision": Type.Ref('Revision'), "sourceIdentity": Type.Ref('SkillSourceIdentity'), "priority": Type.Integer({ minimum: 50, maximum: 500 }), "resolution": Type.Ref('SkillResolution'), "trust": Type.Ref('TrustState'), "desired": Type.Ref('DesiredState'), "actual": Type.Ref('ActualState'), "stale": Type.Boolean(), "lastSafeError": Type.Optional(Type.Ref('SafeError')), "workspaceId": Type.Optional(Type.Ref('WorkspaceId')) }, { additionalProperties: false }),
  ...
  "McpStatus": Type.Object({ "serverId": Type.Ref('ServerId'), "connectionState": Type.Union([Type.Literal('disabled'), Type.Literal('connecting'), Type.Literal('ready'), Type.Literal('degraded'), Type.Literal('unavailable')]), "observedRevision": Type.Union([Type.Ref('Revision'), Type.Null()]), "catalogRevision": Type.Union([Type.Ref('Revision'), Type.Null()]), "toolCount": Type.Integer({ minimum: 0, maximum: 10000 }), "observedAt": Type.String({ format: "date-time" }), "lastSafeError": Type.Optional(Type.Ref('SafeError')), "skippedToolCount": Type.Optional(Type.Integer({ minimum: 0, maximum: 10000 })), "skippedTools": Type.Optional(Type.Array(Type.Object({ "code": Type.Union([Type.Literal('malformed'), Type.Literal('invalid-name'), Type.Literal('invalid-schema'), Type.Literal('schema-too-large'), Type.Literal('description-too-long')]), "name": Type.Optional(Type.String({ minLength: 1, maxLength: 128 })) }, { additionalProperties: false }), { maxItems: 32 })) }, { additionalProperties: false }),
  ...
  "McpTool": Type.Object({ "name": Type.String({ minLength: 1, maxLength: 128 }), "description": Type.String({ maxLength: 4096 }), "inputSchema": Type.Ref('McpInputSchema') }, { additionalProperties: false }),
